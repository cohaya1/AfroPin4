...
class RestaurantTableViewController: UITableViewController {
    ...
    var restaurants: [Restaurant] = [ Restaurant(name: "African Restaurant and Lounge", type: "West African restaurant", location: "6380 GA-85, Riverdale, GA 30274",image:"(678) 961-5878",phone: "African Restaurant and Lounge", description: "Africa Restaurant and Lounge opened in 2008 with the hopes of being the best. We’ve achieved our goal and are now proudly serving many repeat customers. Our customers look to us for great quality and incredible service. We try to deliver on these expectations every time, proudly serving the community. Our unparalleled service, competitive prices, and overall cuisines are why our customers keep returning. We look forward to your patronage.", isVisited: false),
